    ...
    <>
      ...
      <Form.Row>
        ...
        <Form.Group as={Col} md="3" controlId="neighbor">
          <Form.Label>NPE BGP Neighbor #1</Form.Label>
        ...
        <Form.Group as={Col} md="3" controlId="neighbor1">
          <Form.Label>NPE BGP Neighbor #2</Form.Label>
...
export const FormL3VPNSTATIC = (props) => {
  let deviceOption = [<option key="0">-</option>];
  const [intfNumberSelector1, setIntfNumberSelector1] = useState(null);
  const [currentIntfType, setCurrentIntfType] = useState("TenGigE");
  const [currentIntfNumber, setCurrentIntfNumber] = useState("-");
  ...
  return (
    <>
      ...
      <div>NPE Router-Static Settings</div>
      ...
      <div>Access Router-Static Settings</div>
      <div className="border rounded p-2 mb-2">
        <Form.Row>
          <Form.Group as={Col} md="2" controlId="destination-ip2" className="m-0">
            <Form.Control
              ...
              placeholder="destination-ip"
              onChange={props.onChange}
              value={props.inputParams["destination-ip2"]}
            />
          </Form.Group>
          <Form.Group as={Col} md="3" controlId="interface2" className="m-0">
            <Form.Control
              ...
              onChange={props.onChange}
              value={props.inputParams["interface2"]}
            />
          </Form.Group>
          <Form.Group as={Col} md="2" controlId="forward-ip2" className="m-0">
            <Form.Control
              ...
              onChange={props.onChange}
              value={props.inputParams["forward-ip2"]}
            />
          </Form.Group>
        </Form.Row>
      </div>
